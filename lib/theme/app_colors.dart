...
class AppColors {
  ...
  static const Color secondary = Color(0xFFA0BCE0);
  static const Color onSecondary = Color(0xFFFFFFFF);

  static const Color surface = Color(0xFFE0E5EC);
  static const Color onSurface = Color(0xFF35465D);

  static const Color error = Color(0xFFB00020);
  static const Color onError = Color(0xFFFFFFFF);

  static const Color errorContainer = Color(0xFFF6BDBA);
  ...
  static const Color surfaceContainer = Color(0xFFF7F9FC);
  static const Color surfaceContainerHigh = Color(0xFFF1F4F8);
  static const Color surfaceContainerHighest = Color(0xFFE0E5EC);

  static const Color outline = Color(0xFFCBD2DC);
...
// Dark Theme Colors
  ...
  static const Color darkError = Color(0xFFECA3A0);
